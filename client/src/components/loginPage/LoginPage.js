                  ...
                  <form className="sso__login ng-untouched ng-not-empty ng-invalid ng-valid-email ng-invalid-recaptcha ng-dirty ng-valid-parse ng-invalid-required"  ng-model="login" ng-submit="vm.authenticate(login)" style={{}}>
                    ...
                    {/* ngIf: !vm.twoFactorAuthRequired */}<div ng-if="!vm.twoFactorAuthRequired" className="ng-scope">
                      ...
                      <div className="form-group">
                        ...
                        <input type="email" onChange={onChangeLogin} className="form-control ng-touched ng-valid-email ng-dirty ng-empty ng-invalid ng-invalid-required"  id="login_email" ng-model="vm.credentials.email" translate-once-placeholder="EMAIL-ADDRESS-PLACEHOLDER" ng-disabled="vm.data.login.requestPending" required placeholder="Email Address" style={{}} />
                      </div>
                      {/* Password */}
                      <div className="form-group">
                        <label translate-once="PASSWORD" className="text-uppercase">Password</label>
                        <input type="password" onChange={onChangePassword} className="form-control ng-valid-required ng-touched ng-not-empty ng-dirty ng-valid-parse ng-valid"  id="login_password" ng-model="vm.credentials.password" translate-once-placeholder="ENTER-PASSWORD" ng-disabled="vm.data.login.requestPending" required placeholder="Enter password" style={{}} />
